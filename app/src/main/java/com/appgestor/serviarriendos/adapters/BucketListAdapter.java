...
public abstract class BucketListAdapter<T> extends BaseAdapter {
	...
	protected List<ModeloListaServios> elements;
     ...
     * @param elements
     */
    public BucketListAdapter(Activity ctx, List<ModeloListaServios> elements) {
        this(ctx, elements, 1);
    }
	 ...
	 * 
	 */
	public BucketListAdapter(Activity ctx, List<ModeloListaServios> elements, Integer bucketSize) {
	...
	protected abstract View getBucketElement(final int position,
			ModeloListaServios currentElement);
